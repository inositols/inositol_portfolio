...
class LocalData {
  static const List<Project> projects = [
    ...
    Project(
      ...
      roleDescription: 'As the Senior Flutter Engineer, I designed the cryptocurrency wallet interface, integrated multi-factor biometrics authentication, and implemented real-time price tickers using secure WebSocket connections.',
